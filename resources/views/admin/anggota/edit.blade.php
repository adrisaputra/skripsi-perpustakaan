					...
					<div class="row">
						<div class="col-12 col-xl-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="{{ url('/anggota/edit/'.$anggota->id) }}" method="POST" enctype="multipart/form-data">
										{{ csrf_field() }}
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="nis" class="form-control @if ($errors->has('nis')) is-invalid @endif " placeholder="NIS" value="{{ $anggota->nis }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="nama" class="form-control @if ($errors->has('nama')) is-invalid @endif " placeholder="Nama" value="{{ $anggota->nama }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="kelas" class="form-control @if ($errors->has('kelas')) is-invalid @endif " placeholder="Kelas" value="{{ $anggota->kelas }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="telepon" class="form-control @if ($errors->has('telepon')) is-invalid @endif " placeholder="Telepon" value="{{ $anggota->telepon }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="email" class="form-control @if ($errors->has('email')) is-invalid @endif " placeholder="Email" value="{{ $anggota->email }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<textarea id="konten" name="alamat" class="form-control @if ($errors->has('alamat')) is-invalid @endif " rows="3">{{ $anggota->alamat }}</textarea>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												...
												<br><br>
												@if($anggota->foto)
													<img src="{{ asset('/upload/foto/'.$anggota->foto) }}" width="150px" height="200px">
												@endif
											</div>
										</div>
										<div class="form-group row">
