...
@section('konten')
        <main class="content">
								...
								<div class="card-body">
									<form action="{{ url('/slider') }}" method="POST" enctype="multipart/form-data">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input class="form-control @if ($errors->has('judul')) is-invalid @endif " type="text" name="judul" value="{{ old('judul') }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<textarea class="form-control @if ($errors->has('isi')) is-invalid @endif " type="text" name="isi" >{{ old('isi') }}</textarea>
			...
			</main>			<script src="{{asset('assets/ckeditor/ckeditor.js')}}"></script>
<script>
