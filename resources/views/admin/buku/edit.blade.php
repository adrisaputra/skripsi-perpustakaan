					...
					<div class="row">
						<div class="col-12 col-xl-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="{{ url('/buku/edit/'.$buku->id) }}" method="POST" enctype="multipart/form-data">
										{{ csrf_field() }}
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="isbn" class="form-control @if ($errors->has('isbn')) is-invalid @endif " placeholder="ISBN" value="{{ $buku->isbn }}">
											...
											<div class="col-sm-10">
												<select class="form-control @if ($errors->has('kategori_id')) is-invalid @endif " name="kategori_id">
													...
													@foreach ($kategori as $v)
														<option value="{{ $v->id }}"  @if($buku->kategori_id==$v->id) selected @endif >{{ $v->nama_kategori }}</option>
													@endforeach
												</select>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="judul" class="form-control @if ($errors->has('judul')) is-invalid @endif " placeholder="Judul" value="{{ $buku->judul }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="nama_penulis" class="form-control @if ($errors->has('nama_penulis')) is-invalid @endif " placeholder="Nama Penulis" value="{{ $buku->nama_penulis }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="nama_penerbit" class="form-control @if ($errors->has('nama_penerbit')) is-invalid @endif " placeholder="Nama Penerbit" value="{{ $buku->nama_penerbit }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="tahun_terbit" class="form-control @if ($errors->has('tahun_terbit')) is-invalid @endif " placeholder="Tahun Terbit" value="{{ $buku->tahun_terbit }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="jumlah_buku" class="form-control @if ($errors->has('jumlah_buku')) is-invalid @endif " placeholder="Jumlah Buku" value="{{ $buku->jumlah_buku }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" name="rak_buku" class="form-control @if ($errors->has('rak_buku')) is-invalid @endif " placeholder="Rak Buku" value="{{ $buku->rak_buku }}">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<textarea id="konten" name="deskripsi" class="form-control @if ($errors->has('deskripsi')) is-invalid @endif " rows="10">{{ $buku->deskripsi }}</textarea>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												...
												<br><br>
												@if($buku->cover)
													<img src="{{ asset('/upload/cover/'.$buku->cover) }}" width="150px" height="200px">
												@endif
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-sm-10">
												...
												<br><br>
												@if($buku->file)
													<a href="{{ asset('/upload/file/'.$buku->file) }}" target="_blank"> Lihat File</href>
												@endif
											</div>
										</div>
