					...
					<div class="row">
						<div class="col-12 col-xl-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="{{ url('/peminjaman/edit2/'.$peminjaman->id) }}" method="POST" enctype="multipart/form-data">
										{{ csrf_field() }}
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="hidden" class="form-control" value="{{ $peminjaman->buku_id }}" name="buku_id">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="hidden" class="form-control" value="{{ $peminjaman->anggota_id }}" name="anggota_id">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="hidden" class="form-control" value="{{ $peminjaman->tanggal_pinjam }}" name="tanggal_pinjam">
												<input type="text" class="form-control @if ($errors->has('email')) is-invalid @endif " value="{{ $peminjaman->tanggal_pinjam }}" disabled>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="hidden" class="form-control" value="{{ $peminjaman->tanggal_kembali }}" name="tanggal_hrs_kembali">
												<input type="text" class="form-control @if ($errors->has('email')) is-invalid @endif " value="{{ $peminjaman->tanggal_kembali }}" disabled>
											</div>
										</div>
										
										<?php 
											$t = date_create($peminjaman->tanggal_kembali);
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="hidden" class="form-control" value="{{ $hari }}" name="hari">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												...
												<input type="text" class="form-control" value="{{ $total_denda }}" disabled>
											</div>
										</div>
